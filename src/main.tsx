...
registerServiceWorker(() => {
  ...
  bar.innerHTML =
    ...
    '<button style="background:#ff6b4a;color:#fff;border:0;border-radius:999px;padding:6px 14px;font:inherit;cursor:pointer">Reload</button>' +
    '<button aria-label="Dismiss" style="background:none;border:0;color:#6c6c7a;font:inherit;cursor:pointer">✕</button>'
